...
:::{exercise}
:class: dropdown
:label: exo-propag-xpositif

Soit l'onde monochromatique à une dimension observée en $x$ et à l'instant $t$ :
$f(x,t)= a \cos(kx - \omega t)$

1. Remontons dans le temps et considérons l'instant $t' = t - dt$ ou $dt$ est un petit intervalle de temps positif. En quel lieu de l'espace $x'$, la valeur de la phase de l'onde est égale à la phase $(kx - \omega t)$ ?

1. Qu'en déduit-on sur le sens de propagation associé à l'onde monochromatique $f(x,t)= a \cos(kx - \omega t)$ ?
