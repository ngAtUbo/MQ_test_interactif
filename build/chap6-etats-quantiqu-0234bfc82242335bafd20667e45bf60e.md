...
1. Ecrire $\widehat{A} = \sum_{i=1}^{3} \lambda_i \left| v_{i} \right\rangle \left\langle v_{i} \right|$ dans la base des états $\left\{ \left| e_{i} \right\rangle \right\}$. Conclusion.
:::
