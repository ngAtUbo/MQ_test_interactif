...
:::{attention}
La relation {eq}`eq-orthonormal` ne signifie pas que les vecteurs $\left| u_{k} \right\rangle$ forment une base othornormée car la relatuin ne fait état de la {index}`complétude` de l'ensemble.
:::
