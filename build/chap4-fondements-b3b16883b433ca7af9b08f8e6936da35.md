...
On a donc une fonction qui oscille trÃƒÆ’Ã‚Â¨s rapidement
$\cos( k_{0}x )$ et dont l\'amplitude est modulÃƒÆ’Ã‚Â©e par une
...
:name: fig-paquetOnde
:alt: Paquet d'ondes pÃƒÆ’Ã‚Â©riodique
:width: 90%
Paquet d'ondes pÃƒÆ’Ã‚Â©riodique
```
...
infinitÃƒÆ’Ã‚Â© d\'images du lobe centrale comme le montre la {numref}`fig-paquetOnde`. En rÃƒÆ’Ã‚Â©alitÃƒÆ’Ã‚Â© il est possible de construire une
