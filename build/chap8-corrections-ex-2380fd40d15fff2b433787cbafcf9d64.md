...
$\rho(x) = \frac{1}{\sigma \sqrt{2 \pi}}\;\exp \left(\frac{-x^{2}}{2\sigma^2}\right)=\frac{2}{\sigma\sqrt{2\pi}}$
...
1. $\left\langle|x| \right\rangle = \int_{-\infty}^{+-\infty}|x|\rho(x)dx = \frac{2}{\sigma\sqrt{2\pi}\int_{O}^{+-\infty}x\exp \left(\frac{-x^{2}}{2\sigma^2}\right) dx$
