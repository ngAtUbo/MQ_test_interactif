Ã¯Â»Â¿# ProbabilitÃƒÆ’Ã‚Â©s et amplitudes quantiques
...
**d\'amplitude de probabilitÃƒÆ’Ã‚Â©** {index}`Amplitude de probabilitÃƒÆ’Ã‚Â©` est nÃƒÆ’Ã‚Â©cessaire pour expliquer
...
d\'**amplitude de probabilitÃƒÆ’Ã‚Â© de transition** {index}`Amplitude de probabilitÃƒÆ’Ã‚Â© de transition`. Une telle amplitude est
...
**superposition des amplitudes** (PSAP) {index}`Principe de superposition des amplitudes` joue un rÃƒÆ’Ã‚Â´le capital
...
tel facteur est appelÃƒÆ’Ã‚Â© **facteur de phase** {index}`Facteur de phase`.
...
$${A_{1} = ÃƒÂ¢Ã…Â¸Ã‚Â¨D || SÃƒÂ¢Ã…Â¸Ã‚Â©}_{1}$$

Pour la seule fente 2 ouverte :

$${A_{2} = ÃƒÂ¢Ã…Â¸Ã‚Â¨D || SÃƒÂ¢Ã…Â¸Ã‚Â©}_{2}$$
...
$$ÃƒÂ¢Ã…Â¸Ã‚Â¨v || uÃƒÂ¢Ã…Â¸Ã‚Â©_{s} = ÃƒÂ¢Ã…Â¸Ã‚Â¨v || sÃƒÂ¢Ã…Â¸Ã‚Â©ÃƒÂ¢Ã…Â¸Ã‚Â¨s || uÃƒÂ¢Ã…Â¸Ã‚Â©$$
...
$${A_{1} = ÃƒÂ¢Ã…Â¸Ã‚Â¨D || SÃƒÂ¢Ã…Â¸Ã‚Â©}_{1} = ÃƒÂ¢Ã…Â¸Ã‚Â¨D || 1ÃƒÂ¢Ã…Â¸Ã‚Â©ÃƒÂ¢Ã…Â¸Ã‚Â¨1 || SÃƒÂ¢Ã…Â¸Ã‚Â©$$

$${A_{2} = ÃƒÂ¢Ã…Â¸Ã‚Â¨D || SÃƒÂ¢Ã…Â¸Ã‚Â©}_{2} = ÃƒÂ¢Ã…Â¸Ã‚Â¨D || 2ÃƒÂ¢Ã…Â¸Ã‚Â©ÃƒÂ¢Ã…Â¸Ã‚Â¨2 || SÃƒÂ¢Ã…Â¸Ã‚Â©$$
