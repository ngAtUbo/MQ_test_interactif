...
où $E = \hbar \;\omega = \hbar \;c\;k$ est l'énergie du photon (voir {eq}`eq-PlanckEinstein` du [chapitre](#chap-lumiere)) et $n(r)$ l'indice de réfraction dépendant de la position donnée $r$ pour un milieu non homogène.
...
dans un mileu homogène d'indice $n$ et pour un chemin de longueur $L$.
