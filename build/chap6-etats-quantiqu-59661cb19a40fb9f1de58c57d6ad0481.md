...
Calculer le produit matriciel  $\widehat{E}_{\left\{ \left| \phi \right\rangle$ dans lequel les représentations matricielles de $\widehat{E}$  et $\left| \phi \right\rangle$ dans la base $\mathcal{B}$ sont données par respectivement :
