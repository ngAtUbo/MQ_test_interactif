...
*  $\left(\left\langle w \right| = (1+i)\left\langle 0 \right| - 4  \left\langle 1 \right| \right)^{\dagger}$

*  $\left(\left\langle u \right| = a^{*}\left\langle 0 \right| - ib^{*}  \left\langle 1 \right| \right)^{\dagger}$ où $a, b \in \mathbb{C}$
:::
...
1. En déduire les valeurs propres de $\widehat{A}$.
...
1. $\lambda_1=1$,  $\lambda_2=2$ et $\lambda_3=4$

1. $\left| v_{1} \right\rangle_{\left\{ \left| e_{i} \right\rangle \right\}} = \frac{1}{\sqrt{2}} \begin{pmatrix}
1 \\
-1 \\
1
\end{pmatrix}$, $\left| v_{2} \right\rangle_{\left\{ \left| e_{i} \right\rangle \right\}} = \frac{1}{\sqrt{3}} \begin{pmatrix}
1 \\
0 \\
-1
