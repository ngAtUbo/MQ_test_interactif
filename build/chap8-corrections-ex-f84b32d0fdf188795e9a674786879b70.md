...
* chapitre {ref}`chap-lumiere`
    ...
    :class: dropdown
    $\frac{F_{c}}{F_{G}} = \frac{e^{2}}{4 \pi \varepsilon_{0} G M_{p} m_{e}}=\left(1,602 \times 10^{-19}\right)^2/\left(4 \pi 8,854\times 10^{-12} 6,6742 \times 10^{- 11} 1,673 \times 10^{- 27} 9,109 \times 10^{- 31}\right) =  2,3 \times 10^{39}.$ Ainsi la force de Coulomb est de $39$ ordres de grandeur fois plus importante que l'attraction gravitationnelle proton-électron.
    :::
