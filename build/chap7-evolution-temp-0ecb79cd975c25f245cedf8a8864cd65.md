...
opérateur hamiltonien {index}`Opérateur hamiltonien`.
...
$$\left( \widehat{1} + \frac{\widehat{H}}{i\hslash}dt \right)\left. \left| \Psi(t) \right. \right\rangle = \left. \left| \Psi(t + dt) \right. \right\rangle$$

$$\left. \widehat{H}dt\left| \Psi(t) \right. \right\rangle = i\hslash\left\lbrack \left. \left| \Psi(t + dt) \right. \right\rangle - \left. \left| \Psi(t) \right. \right\rangle \right\rbrack$$

et finalement l'équation différentielle :

$$\left. \widehat{H}\left| \Psi(t) \right. \right\rangle = i\hslash\frac{d}{dt}\left. \left| \Psi(t) \right. \right\rangle$$
...
> 6°) <u>L\'évolution temporelle de</u>
...
$$\left. \left\langle \left. u_{k} \right| \right.\widehat{H}\left| \Psi(t) \right. \right\rangle = i\hslash\frac{d}{dt}\left\langle u_{k} \middle| \Psi(t) \right\rangle$$

En utilisant la relation de fermeture :

$$\sum_{l = 1}^{N}\left. \left\langle \left. u_{k} \right| \right.\widehat{H}\left| u_{l} \right. \right\rangle\left\langle u_{l} \middle| \Psi(t) \right\rangle = i\hslash\frac{d}{dt}\left\langle u_{k} \middle| \Psi(t) \right\rangle$$
...
$$\left. \left\langle \left. \Phi_{k} \right| \right.\widehat{H}\left| \Psi(t) \right. \right\rangle = i\hslash\frac{d}{dt}\left\langle \Phi_{k} \middle| \Psi(t) \right\rangle$$
...
Elles sont indépendantes du temps ce qui justifie l'appellation d'états
stationnaires {index}`Etats stationnaires` pour ces états
...
${\left. \left| \Psi(t) \right. \right\rangle = e}^{- iE_{1}t/\hslash}\left. \left| \Phi_{1} \right. \right\rangle$

soit :

$${\left. \left| \Psi(t) \right. \right\rangle = e}^{- iE_{1}t/\hslash}\left. \left| \Psi(0) \right. \right\rangle$$
...
$$c_{l}(t) = c_{l}(0)e^{- iE_{k}t/\hslash}l = 1,2\;\text{à}\;N$$
...
est appelée équation de Schrödinger indépendante du temps ou équation
...
> :
> $\left. \left| \Psi(t) \right. \right\rangle = \sum_{l}^{}{c_{l}(0)}e^{- iE_{l}t/\hslash}\left. \left| \Phi_{l} \right. \right\rangle$
...
$$\left\langle \left. \Psi(t) \right|\widehat{H} \right. = - i\hslash\frac{d}{dt}\left\langle \left. \Psi(t) \right| \right.$$

On obtient :

$$i\hslash\left\langle \widehat{A} \right\rangle_{\Psi} = - \left\langle \left. \Psi(t) \right| \right.\widehat{H}\widehat{A}\left. \left| \Psi(t) \right. \right\rangle + \left\langle \left. \Psi(t) \right| \right.\widehat{A}\left. \widehat{H}\left| \Psi(t) \right. \right\rangle + i\hslash\left\langle \left. \Psi(t) \right| \right.\frac{\partial\widehat{A}}{\partial t}\left. \left| \Psi(t) \right. \right\rangle$$

soit :

$$i\hslash\left\langle \widehat{A} \right\rangle_{\Psi} = \left\langle \left. \Psi(t) \right| \right.\left\lbrack \widehat{A,}\widehat{H} \right\rbrack\left. \left| \Psi(t) \right. \right\rangle + i\hslash\left\langle \left. \Psi(t) \right| \right.\frac{\partial\widehat{A}}{\partial t}\left. \left| \Psi(t) \right. \right\rangle$$

c'est-à-dire :

$$i\hslash\left\langle \widehat{A} \right\rangle_{\Psi} = \left\langle \left\lbrack \widehat{A,}\widehat{H} \right\rbrack \right\rangle_{\Psi} + i\hslash\left\langle \frac{\partial\widehat{A}}{\partial t} \right\rangle_{\Psi}$$
...
$$\left| \Psi(t) \right\rangle = c_{a}(0)e^{- iE_{a}t/\hslash}\left| \varphi_{a} \right\rangle + c_{b}(0)e^{- iE_{b}t/\hslash}\left| \varphi_{b} \right\rangle = c_{a}(0)e^{- i\left( E_{0} - a \right)t/\hslash}\left| \varphi_{a} \right\rangle + c_{b}(0)e^{- i\left( E_{0} + a \right)t/\hslash}\left| \varphi_{b} \right\rangle$$


```{math}
:label: eq-49

\left| \Psi(t) \right\rangle = e^{- iE_{0}t/\hslash}\left\lbrack c_{a}(0)e^{iat/\hslash}\left| \varphi_{a} \right\rangle + c_{b}(0)e^{- iat/\hslash}\left| \varphi_{b} \right\rangle \right\rbrack
```
...
$$\left| \Psi(t) \right\rangle = \frac{e^{- iE_{0}t/\hslash}}{\sqrt{2}}\left\lbrack e^{iat/\hslash}\left| \varphi_{a} \right\rangle + e^{- iat/\hslash}\left| \varphi_{b} \right\rangle \right\rbrack$$
