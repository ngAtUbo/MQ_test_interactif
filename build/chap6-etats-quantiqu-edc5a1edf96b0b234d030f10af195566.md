...
:::{admonition} Exercice ket $\rightsquigarrow$ bra 
:class: dropdown
Calculer le conjugué hermitique :

*  $\left| \Psi \right\rangle = 3 \left| 0 \right\rangle - i \left| 1 \right\rangle$

*  $\left| \phi \right\rangle = \alpha \left| 0 \right\rangle + \beta \left| 1 \right\rangle$ où $\alpha,\; \beta in \mathbb{R}$

*  $\left| \psi \right\rangle = (2-i)\;\alpha \left| 0 \right\rangle + (1+3i)\; \beta \left| 1 \right\rangle$ où $\alpha,\; \beta \in \mathbb{R}$
:::
...
Calculer 
*  $left( \cdot  \left\langle \xi \right| = (1+i)\left\langle 0 \right| - 4  \left\langle 1 \right| \right)^{\dagger}$

*  $left( \cdot  \left\langle u \right| = a^{*}\left\langle 0 \right| - ib^{*}  \left\langle 1 \right| \right)^{\dagger}$
:::
