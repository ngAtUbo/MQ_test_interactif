...
opÃƒÆ’Ã‚Â©rateur hamiltonien {index}`OpÃƒÆ’Ã‚Â©rateur hamiltonien`.
...
Elles sont indÃƒÆ’Ã‚Â©pendantes du temps ce qui justifie l'appellation d'ÃƒÆ’Ã‚Â©tats
stationnaires {index}`Etats stationnaires` pour ces ÃƒÆ’Ã‚Â©tats
...
est appelÃƒÆ’Ã‚Â©e ÃƒÆ’Ã‚Â©quation de SchrÃƒÆ’Ã‚Â¶dinger indÃƒÆ’Ã‚Â©pendante du temps ou ÃƒÆ’Ã‚Â©quation
aux valeurs propres {index}`Equation aux valeurs propres`.
...
constante du mouvement {index}`Constante du mouvement`.
