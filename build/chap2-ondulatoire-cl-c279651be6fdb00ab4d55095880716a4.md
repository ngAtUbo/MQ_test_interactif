...
conduisant à l\'<u>intensité [^myref] instantanée</u>
...
un état excité [^myref], peut revenir dans son état fondamental (état de
...
matière lorsqu'il se trouve dans un état excité [^myref], peut revenir dans
...
$c$ durant un intervalle de temps $t$.
 ...
 [^myref]: L\'intensité instantanée électromagnétique est à distinguer de
 ...
 [^myref]: Les niveaux d'énergies d'un atome sont quantifiés comme on
