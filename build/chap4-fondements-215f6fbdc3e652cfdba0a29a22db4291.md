...
On a donc une fonction qui oscille très rapidement comme le montre la figure tracée par le [script Python](#markdown-WP)
$\cos\left( k_{0}x \right)$. L\'amplitude est modulée par une
