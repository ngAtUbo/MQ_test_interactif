...
dans un mileu homogène d'indice $n$ et longueur $L$.

Pour un photon de fréquence fixée $\omega$ la phase accumulée sur le chemin est :
...
$$A = exp\left(j\frac{S}{\hbar}\right) = \exp \left(j k_0 n L\right)$$
...
où l'inidce de réfraction du milieu considéré, l'air, est pris comme valant $1$.
