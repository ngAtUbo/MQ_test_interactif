...
On considère un système quantique dont l'espace des états $\epsilon$ est de dimension 2 (qubit) et dont la base orthonormée est donnée par : $\left\{ \left. \left| O \right. \right\rangle,\left\{ \left. \left| 1 \right. \right\rangle \right\}$
...
1. Déterminer la représentation matricielle de $\widehat{H}$ dans la base $\left\{ \left. \left| O \right. \right\rangle,\left\{ \left. \left| 1 \right. \right\rangle \right\}$.
...
1. Écrire l'équation de Schrödinger dans la base $\left\{ \left. \left| O \right. \right\rangle,\left\{ \left. \left| 1 \right. \right\rangle \right\}$.

1. En déduire l'état $\left| \Psi(t) \right\rangle$ à l'instant $t$.

1. Calculer la probabilité de trouver le système dans l'état $\left| 1 \right. \right\rangle$.
:::
