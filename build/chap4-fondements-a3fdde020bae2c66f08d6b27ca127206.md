...
def f_of_x(x,t, k,a,k0):
    """
    return |psi(x,t)|**2
    intrale sur k calculée avec méthode des trapèzes
    """
...
# Paramètres du paquet d’onde (valeur abrbitraires) pour electron de 100 à 150 eV
a = 1.0
k0 = 6.3e10 
...
# estimation du temps pour parcourir 100m
t5m = 100 / vg
...
for t in t_values:
    ...
    plt.title(f"|Paquet d’onde gaussien|^2")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
