...
où $E = \hbar \;\omega = \hbar \;c\;k$ est l'énergie du photon (voir {eq}`eq-PlanckEinstein` du chapitre [La lumière](#chap-lumiere)) et $n(r)$ l'indice de réfraction dépendant de la position donnée $r$ pour un milieu non homogène.
