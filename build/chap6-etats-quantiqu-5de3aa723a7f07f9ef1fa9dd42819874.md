...
En illustration et complément au formalisme de Dirac, certaines applications optionnelles seront proposées dans ce chapitre sous forme de programme en langage Python utilisant le *package* {cite}`Li2022pulselevelnoisy`.
